...
class MacOsWebview2 extends StatefulWidget {
  const MacOsWebview2({super.key});

  @override
  State<MacOsWebview2> createState() => _MacOsWebview2State();
}

class _MacOsWebview2State extends State<MacOsWebview2> {
